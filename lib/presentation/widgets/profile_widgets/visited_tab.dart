...
class VisitedPlacesTab extends StatelessWidget {
  final String uid;

  const VisitedPlacesTab({super.key, required this.uid});
    ...
    return StreamBuilder(
      ...
      builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return const Center(child: Text("No visited places found"));
        }

        var visitedPlaces = snapshot.data!.docs;
        ...
        return Padding(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              var place = visitedPlaces[index].data() as Map<String, dynamic>;
